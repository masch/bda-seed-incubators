...
const char *INFLUXDB_URL = INFLUXDB_URL_MACRO;
const char *INFLUXDB_TOKEN = INFLUXDB_TOKEN_MACRO;
const char *INFLUXDB_ORG = INFLUXDB_ORG_MACRO;
const char *INFLUXDB_BUCKET = INFLUXDB_BUCKET_MACRO;
